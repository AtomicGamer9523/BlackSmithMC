...
impl Plugin for FeatherWorldFormat {
    ...
    fn info(&self) -> PluginInfo {
        PluginInfo {
            name: "BSMCWorldFormat",
            id: "bsmc_world_format",
        }
    }
    ...
    fn initialize(&mut self, setup: &mut dyn Setup<Self>) -> anyhow::Result<Self::State> {
        ...
        setup
            .game_mut()
            .register_world_source_factory("bsmc", Box::new(BSMCWorldSourceFactory));
...
pub struct BSMCWorldSourceFactory;

impl WorldSourceFactory for BSMCWorldSourceFactory {
    fn create_world_source(
        ...
        Ok(Box::new(BSMCWorldSource::new(
...
impl WorldSource for BSMCWorldSource {
